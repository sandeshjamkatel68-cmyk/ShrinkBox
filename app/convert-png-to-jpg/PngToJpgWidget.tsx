    ...
    <div className="w-full flex flex-col gap-4">
      ...
      {file && status === "idle" && (
        <div className="flex flex-col gap-4">
          ...
          <button onClick={handleConvert} className="w-full bg-brand hover:bg-brand-dim text-white font-semibold rounded-xl py-3 text-sm transition-colors">Convert to JPG</button>
        </div>
      )}
