        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] overflow-hidden">
          ...
          <div className="px-6 py-5">
            <div className="grid grid-cols-3 gap-4 mb-5">
              <div><div className="text-xs text-[var(--text-muted)] mb-1">Original</div><div className="text-xl font-semibold">{formatBytes(result.originalSize)}</div></div>
            ...
            {result.reductionPercent > 0 && (
              <p className="text-sm text-[var(--brand)] mb-4">-{result.reductionPercent}% smaller</p>
            )}
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="mb-8 text-center">
        ...
        <p className="text-[var(--text-muted)]">Convert PNG images to JPG format. Transparency is replaced with a white background.</p>
      </div>
      ...
      <div
        ...
        <input ref={inputRef} type="file" accept=".png" className="sr-only"
