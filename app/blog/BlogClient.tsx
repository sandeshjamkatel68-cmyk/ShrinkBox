  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="mb-10 text-center">
        <span className="text-xs font-bold text-brand uppercase tracking-widest bg-brand-light/20 px-3 py-1 rounded-full border border-brand/10">
          Blog &middot; {BLOG_POSTS.length} Articles
        </span>
        <h1 className="text-4xl font-extrabold mt-6 mb-3 tracking-tight text-foreground">
      ...
      <Link
        ...
        className="group block rounded-3xl border-2 border-brand/20 bg-gradient-to-br from-brand-light/20 to-surface p-8 mb-10 hover:border-brand/50 transition-all duration-300 hover:shadow-2xl"
      >
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {filtered.map((post, idx) => (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <span className="text-xs font-medium text-brand bg-brand-light/20 rounded-full px-2.5 py-0.5">
                {post.tag}
              </span>
