      ...
      {!base64 ? (
        ...
        <div className="bg-surface border border-border rounded-2xl p-6 space-y-4 animate-in fade-in duration-500">
          <div className="flex items-center justify-between pb-2 border-b border-border">
            <h4 className="text-xs font-bold text-subtle uppercase tracking-wider">Base64 String</h4>
          ...
          <div className="max-h-[300px] overflow-y-auto pr-2 rounded-lg py-1 border border-border bg-surface-muted p-3">
            <p className="text-[10px] text-muted break-all font-mono leading-normal">
              {base64}
            </p>
          </div>
        </div>
