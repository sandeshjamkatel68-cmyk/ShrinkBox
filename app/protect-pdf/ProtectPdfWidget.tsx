    ...
    <div className="w-full flex flex-col gap-4">
      ...
      {file && status === "idle" && (
        <div className="flex flex-col gap-4">
          ...
          <button onClick={handleProtect} disabled={!password.trim() || mismatch} className="w-full bg-brand hover:bg-brand-dim disabled:opacity-40 text-white font-semibold rounded-xl py-3 text-sm transition-colors">Protect PDF</button>
        </div>
      )}
