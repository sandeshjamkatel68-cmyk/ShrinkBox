  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-bold mb-2">Image to Black & White</h1>
        <p className="text-[var(--text-muted)]">Convert any image to grayscale instantly. Keeps original format and quality.</p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          {preview && (
            <div className="rounded-xl border border-[var(--border)] overflow-hidden">
              <div className="px-3 py-2 text-xs text-[var(--text-muted)] border-b border-[var(--border)]">Original</div>
              <img src={preview} alt="Original" className="w-full object-cover max-h-40" />
            </div>
          )}
          {status === "done" && result?.downloadUrl && (
            <div className="rounded-xl border border-[var(--border)] overflow-hidden">
              <div className="px-3 py-2 text-xs text-[var(--brand)] border-b border-[var(--border)]">Black & White</div>
              <img src={result.downloadUrl} alt="Grayscale" className="w-full object-cover max-h-40" />
            </div>
          )}
        </div>
      )}
