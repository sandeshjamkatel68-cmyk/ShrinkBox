  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      >
        ...
        <p className="text-xs text-[var(--text-muted)]">.heic or .heif only</p>
      </div>
      ...
      {file && (
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 text-center">
          <button 
            ...
            className="w-full h-11 px-8 rounded-xl bg-[var(--brand)] text-white text-sm font-bold shadow-[var(--shadow-sm)] hover:bg-[var(--brand-dim)] disabled:opacity-50 transition-all font-sans"
          >
            {isProcessing ? "Transcending..." : "Convert to JPG"}
          </button>

          {result && (
            <div className="mt-6 pt-6 border-t border-[var(--border)] max-w-sm mx-auto animate-in slide-in-from-bottom-2 duration-300">
