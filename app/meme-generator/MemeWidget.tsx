      ...
      {file && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start animate-in fade-in duration-500">
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 space-y-5">
            <div>
              <label className="block text-[10px] font-bold text-[var(--text-subtle)] uppercase tracking-widest mb-2">Top Text</label>
              <input 
                type="text" 
                value={topText} 
                onChange={(e) => setTopText(e.target.value)}
                className="w-full h-11 px-4 rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] text-sm font-bold focus:outline-none focus:border-[var(--brand)] uppercase"
              />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-[var(--text-subtle)] uppercase tracking-widest mb-2">Bottom Text</label>
              <input 
                type="text" 
                value={bottomText} 
